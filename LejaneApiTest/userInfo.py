...
"""
this module is used for checking user info
author:zhangpeng
"""
...
class MembInfoTestCase(unittest.TestCase):
    """
    test class for modify of member health info
    """
    def setUp(self):
        self.lejaneTest = CommonTools.HttpRequest()
    ...
    def infoQuery(self, membId, checkflag=1):
        ...
        """
        # get org data
        org_data = CommonTools.HttpRequest()
        httpheader = {}
